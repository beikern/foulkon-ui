...
object CreateUserForm {
  ...
  class Backend($: BackendScope[Props, State]) {
    ...
    val externalIdValidationCallback: (ReactEventFromInput, String) => Callback = {
      (event: ReactEventFromInput, actualValue: String) =>
        actualValue match {
          case "" =>
            $.modState(s =>
              s.copy(
    ...
    val pathValidationCallback: (ReactEventFromInput, String) => Callback = {
      (event: ReactEventFromInput, actualValue: String) =>
        actualValue match {
          case "" =>
            $.modState(s =>
    ...
    def render(p: Props, s: State) = {
      ...
      val actions: VdomNode = js
        .Array(
          ...
          MuiFlatButton(key = "2",
            label = "create",
            disabled = js.defined(!s.inputValidated),
            secondary = true,
